...
exports.TemplateAutoPopulationService = void 0;
const ai_service_1 = require("./ai.service");
class TemplateAutoPopulationService {
    constructor() {
     ...
     */
    async populateTemplatesFromTransaction(documents, bankType = 'bank1') {
        try {
    ...
    extractKeyDataFromDocuments(documents) {
        const data = {
        ...
        documents.forEach(doc => {
            ...
            if (doc.entities) {
                if (doc.entities.supplier)
                    data.supplier = { ...data.supplier, ...doc.entities.supplier };
                if (doc.entities.tradingCompany)
                    data.tradingCompany = { ...data.tradingCompany, ...doc.entities.tradingCompany };
                if (doc.entities.customer)
                    data.customer = { ...data.customer, ...doc.entities.customer };
            }
        });
        return data;
    }
    mapFieldToData(field, data) {
        const keyMappings = {
    ...
    async generateCoveringLetter(data, bankType) {
        const templates = {
    ...
    async generateBillOfExchange(data, bankType) {
    ...
    getBillOfExchangeEditableFields(data) {
        return [
            {
                key: 'reference_number',
                label: 'Reference Number',
    ...
    getCoveringLetterTemplateBank1() {
        return {
            content: `
...
Authorized Signature
    ...
    getCoveringLetterTemplateBank2() {
        return {
            content: `
...
Authorized Officer
    ...
    getCoveringLetterTemplateBank3() {
        return {
            content: `
...
Date
     ...
     */
    async generateFinalDocuments(templates) {
...
exports.TemplateAutoPopulationService = TemplateAutoPopulationService;
//# sourceMappingURL=template-auto-population.service.js.map