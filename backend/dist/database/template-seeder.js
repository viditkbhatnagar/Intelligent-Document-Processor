...
async function seedTemplates() {
    try {
        ...
        await Template_1.TemplateModel.deleteMany({});
        // Covering Letter Template
        const coveringLetterTemplate = new Template_1.TemplateModel({
...
[Document list to be populated]
      `
        ...
        const billOfExchangeTemplate = new Template_1.TemplateModel({
...
//# sourceMappingURL=template-seeder.js.map